...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'providers_provider', (
            ...
            ('userref', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fk_provider_user', unique=True, to=orm['auth.User'])),
            ...
            ('phonenumber', self.gf('django.db.models.fields.BigIntegerField')(default=None, blank=True)),
            ('qqnumber', self.gf('django.db.models.fields.BigIntegerField')(default=None, blank=True)),
        ...
        db.create_table(u'providers_providerproduct', (
            ...
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['providers.Provider'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'providers.provider': {
            ...
            'phonenumber': ('django.db.models.fields.BigIntegerField', [], {'default': 'None', 'blank': 'True'}),
            'qqnumber': ('django.db.models.fields.BigIntegerField', [], {'default': 'None', 'blank': 'True'}),
            'site_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'userref': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fk_provider_user'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
        u'providers.providerproduct': {
            ...
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['providers.Provider']", 'null': 'True', 'blank': 'True'})
        }
    }
