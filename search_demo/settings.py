...
DATABASES = {
    'default': {
        ...
        'NAME': 'regeant_db',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    ...
    '/home/kid143/dev_dir/search_demo/search_demo/static/',
)
...
SECRET_KEY = '34trh934h934hrqgrue$^^&9u34@12kf983d$&'
